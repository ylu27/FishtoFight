...
* `hc' is hascons flag, =1 if regressors include constant
	...
	local cn : subinstr local cn "_cons" "_cons" , /*
...
* Add the one column to Xhat if it belongs there, and then inverse of cross-product matrix
